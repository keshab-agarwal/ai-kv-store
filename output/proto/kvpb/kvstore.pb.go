...
const file_proto_kvstore_proto_rawDesc = "" +
	"\n" +
	"\x13proto/kvstore.proto\x12\akvstore\"\x1e\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
	...
	"\x06Delete\x12\x16.kvstore.DeleteRequest\x1a\x17.kvstore.DeleteResponseB\x14Z\x12kvstore/proto/kvpbb\x06proto3"
...
var file_proto_kvstore_proto_depIdxs = []int32{
	...
	4, // 2: kvstore.KVService.Delete:input_type -> kvstore.DeleteRequest
	1, // 3: kvstore.KVService.Get:output_type -> kvstore.GetResponse
	3, // 4: kvstore.KVService.Put:output_type -> kvstore.PutResponse
	5, // 5: kvstore.KVService.Delete:output_type -> kvstore.DeleteResponse
